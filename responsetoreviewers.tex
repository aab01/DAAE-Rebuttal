...
\begin{itemize}
    ...
    \item the AAE paper \{makhzani2015adversarial\} presented {\color{synthesis}} results on MNIST, SVHN and heavily cropped faces of the Fray dataset, none of which are in colour.
    \item Kingma's VAE paper presents {\color{syntheis}} results on Fray and MNIST.
